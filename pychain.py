...
sender_detail= st.text_input("sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_detail= st.text_input("receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_detail= st.text_input("amount")

input_data=Record(sender=sender_detail,receiver=receiver_detail,amount=amount_detail)
